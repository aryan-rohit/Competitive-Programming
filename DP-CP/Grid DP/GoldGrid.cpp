...
// Input Format: The first line contains 2 integers N and M, the size of the gamefield and the number of gold coins in the field respectively.
...
// 5 5
// 6 2
// Output Format: Output one integer, the maximum number of gold coins Sayan can get.
// Sample Output: 3
